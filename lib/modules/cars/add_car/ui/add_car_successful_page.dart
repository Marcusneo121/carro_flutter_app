...
class AddCarSuccessfulPage extends StatefulWidget {
  const AddCarSuccessfulPage({super.key});

  @override
  State<AddCarSuccessfulPage> createState() => _AddCarSuccessfulPageState();
}

class _AddCarSuccessfulPageState extends State<AddCarSuccessfulPage> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          'We will let your potential guest know about your lovely car.',
